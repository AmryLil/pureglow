...
<aside id="default-sidebar"
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <div class="mb-4 flex justify-start items-center bg-slate-50 py-1  rounded-sm ">
            <div class="text-slate-900 font-bold text-2xl text-center w-full">
                <div>Mask<span class="text-red-600">Glow</span></div>
            </div>
        </div>
